...
var ZH = MessageMap{
	...
	"flag_strategy":        "生成策略 (simple/pronounceable/passphrase/memorable/segmented, 默认: simple)",
	...
	"error_invalid_passphrase_length": "无效词数: 必须在 4 到 10 之间",
	"error_invalid_count":             "无效数量: 必须在 1 到 100 之间",
	"error_invalid_strategy":          "无效策略",
	"error_invalid_charset":           "无效字符集",
	"error_invalid_output":            "无效输出格式: 必须是 simple、json、csv 或 table",
}
