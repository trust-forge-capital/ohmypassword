...
LDFLAGS := "-X github.com/trust-forge-capital/ohmypassword/cmd/cli.version=$(VERSION) -X github.com/trust-forge-capital/ohmypassword/cmd/cli.buildTime=$(BUILDTIME) -X github.com/trust-forge-capital/ohmypassword/cmd/cli.gitCommit=$(GITCOMMIT)"
